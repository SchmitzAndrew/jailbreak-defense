...
if os.path.isfile("results/new_gpt_results.json"):
    with open("results/new_gpt_results.json", "r") as json_file:
...
for _, row in benchmark_df.iterrows():
    ...
    while True:
        try:
            ...
            with open("results/new_gpt_results.json", "w") as json_file:
...
print("Results saved to results/new_gpt_results.json")